...
1. Clone the repository: `git clone git@github.com:scotch-io/node-gitApp`
...
This repo corresponds to the Node App Tutorial Series on [scotch.io](http://scotch.io)

Each branch represents a certain tutorial.
- tut1-starter: [Creating a Single Page App App with Node and Angular](https://scotch.io/tutorials/creating-a-single-page-gitApp-app-with-node-and-angular)
